...
public class Token {
    ...
    protected static Token fromBytes(final byte[] bytes) {
        ...
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(bytes)) {
            ...
            return new Token(version, timestampSeconds,
    ...
    public static Token fromString(final String string) {
        return fromBytes(Base64.decode(string, Base64.URL_SAFE));
    }
    ...
    protected byte[] validateAndDecrypt(final Key key) { //, final long earliestValidInstant, final long latestValidInstant) {
...
//            throw new TokenValidationException("Token timestamp is in the future (clock skew).");
    ...
    public void writeTo(final OutputStream outputStream) throws IOException {
        try (DataOutputStream dataStream = new DataOutputStream(outputStream)) {
            ...
            dataStream.writeLong(0); //getTimestamp().getEpochSecond()
    ...
    public String toString() {
        ...
        builder.append("Token [version=").append(String.format("0x%x", new BigInteger(1, new byte[] {getVersion()})))
                ...
                .append(", hmac=").append(Base64.encodeToString(getHmac(), Base64.URL_SAFE)).append(']');
